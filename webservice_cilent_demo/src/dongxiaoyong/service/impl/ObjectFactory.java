 ...
 * generated in the dongxiaoyong.service.impl package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetWeatherResponse_QNAME = new QName("http://impl.service.dongxiaoyong/", "getWeatherResponse");
    private final static QName _GetWeather_QNAME = new QName("http://impl.service.dongxiaoyong/", "getWeather");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: dongxiaoyong.service.impl
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service.dongxiaoyong/", name = "getWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service.dongxiaoyong/", name = "getWeather")
