 ...
 * 
 */
@WebServiceClient(name = "WeatherServiceImplService", targetNamespace = "http://impl.service.dongxiaoyong/", wsdlLocation = "http://127.0.0.1:8888/weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVICEIMPLSERVICE_QNAME = new QName("http://impl.service.dongxiaoyong/", "WeatherServiceImplService");
    ...
    public WeatherServiceImpl getWeatherServiceImplPort() {
        return super.getPort(new QName("http://impl.service.dongxiaoyong/", "WeatherServiceImplPort"), WeatherServiceImpl.class);
    }
    ...
    public WeatherServiceImpl getWeatherServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.dongxiaoyong/", "WeatherServiceImplPort"), WeatherServiceImpl.class, features);
    }
